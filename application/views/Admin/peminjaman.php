          <div class="container-xxl container-p-y">
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">E-Perpus📚 || </span> Peminjaman
            </h4>
            <div id="ngilang">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    if ($pe['status'] == 'Ditinjau') { ?>
                                      <a onclick="return confirm('Anda yakin memperbarui status Dipinjam..?')" type="submit" class="btn btn-sm btn-success" href="<?= base_url('Peminjaman/updatestatus/' . $pe['id_detail_peminjaman']) ?>"> <?= $pe['status'] ?> </a>
                                    <?php } elseif ($pe['status'] == 'Dipinjam') { ?>
                                      <a onclick="return confirm('Anda yakin memperbarui status Dikembalikan..?')" type="submit" class="btn btn-sm btn-warning" href="<?= base_url('Peminjaman/updatestatusselesai/' . $pe['id_detail_peminjaman']) ?>"> <?= $pe['status'] ?> </a>
                                    <?php } elseif ($pe['status'] == 'Dikembalikan') { ?>
                                      <a onclick="return confirm('Anda yakin memperbarui status Ditinjau..?')" type="submit" class="btn btn-sm btn-secondary" href="<?= base_url('Peminjaman/updatestatuse/' . $pe['id_detail_peminjaman']) ?>"> <?= $pe['status'] ?> </a>
                                    <?php } else { ?>
